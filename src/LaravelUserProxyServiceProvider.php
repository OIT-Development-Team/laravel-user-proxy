...
namespace OITDevelopmentTeam\LaravelUserProxy;

use Illuminate\Support\Facades\Blade;
use Illuminate\Support\ServiceProvider;
use OITDevelopmentTeam\LaravelUserProxy\LaravelUserProxy;
...
class LaravelUserProxyServiceProvider extends ServiceProvider
{
    public function boot()
    {
        ...
        Blade::component('laravel-user-proxy::components.user-proxy-mode-bar', 'user-proxy-mode-bar');
